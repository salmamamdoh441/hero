...
class HomeLessScreen extends StatefulWidget {
  const HomeLessScreen({super.key});
  static const route = '/homeLess' ;
  @override
  State<HomeLessScreen> createState() => _HomeLessScreenState();
}
...
class _HomeLessScreenState extends State<HomeLessScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
            appBar: AppBar(
              title: const Text("hhhhhhhhhhhhhhhhh"),
              centerTitle: true,
            ),
